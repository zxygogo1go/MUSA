'''
Customized registration model: TransMorph
...
Original version:
    ...
    Original paper:
        Chen, Junyu, et al. "TransMorph: Transformer for Unsupervised Medical Image Registration. 
        Medical Image Analysis, p. 102615, 2022.
    ...
    Code Reference:
        https://github.com/junyuchen245/TransMorph_Transformer_for_Medical_Image_Registration/blob/main/TransMorph/models/TransMorph.py
            SHA: https://github.com/junyuchen245/TransMorph_Transformer_for_Medical_Image_Registration/blob/12dd5a1b142161752302f29c9956a95873a97173/TransMorph/models/TransMorph.py
        https://github.com/junyuchen245/TransMorph_Transformer_for_Medical_Image_Registration/blob/main/TransMorph/models/configs_TransMorph.py
            SHA: https://github.com/junyuchen245/TransMorph_Transformer_for_Medical_Image_Registration/blob/f06934a13c736438541eea12d780c59eeb534d28/TransMorph/models/configs_TransMorph.py
        ...
        Modified:
            class TransMorph
                1). use updated SpatialTransformer
                    The native SpatialTransformer is not used
                2). modify the forward function
                    takes (moving, fixed) as inputs and concatenate afterwards
                    this matches with other models
            class WindowAttention:
                1). add indexing='ij' to torch.meshgrid to get rid of warning
...
class TransMorph(nn.Module):
    def __init__(self, config):
        ...
        self.spatial_trans = utils_warp.SpatialTransformer(size=config.img_size)

        self.avg_pool = nn.AvgPool3d(3, stride=2, padding=1)
    
    
    # H.LIU removed
    #   Also, it should be source = x[:, 0:1, :, :, ], although the current code x[:, 0:1, :, :] still works
    # def forward(self, x):
    #     source = x[:, 0:1, :, :]
